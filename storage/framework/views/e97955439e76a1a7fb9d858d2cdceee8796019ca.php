<nav class="main-header navbar navbar-expand navbar-white navbar-light">
    ...
    <ul class="navbar-nav ml-auto">
        ...
        <li class="nav-item">
            <a class="nav-link" data-widget="control-sidebar" data-slide="true" href="adminlte/#">
                <i class="fas fa-th-large"></i>
            </a>
        </li>
    </ul>
</nav>
<?php /**PATH C:\Users\Leap Lyhour\PhpstormProjects\laravel-crud\resources\views/admin/inc/header.blade.php ENDPATH**/ ?>